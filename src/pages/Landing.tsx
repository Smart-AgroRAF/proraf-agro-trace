      ...
      <section className="py-20 bg-card">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center p-6 rounded-lg bg-gradient-card shadow-soft hover:shadow-lg hover:-translate-y-2 transition-all duration-300 animate-fade-in" style={{ animationDelay: "0.1s" }}>
            ...
            <div className="text-center p-6 rounded-lg bg-gradient-card shadow-soft hover:shadow-lg hover:-translate-y-2 transition-all duration-300 animate-fade-in" style={{ animationDelay: "0.2s" }}>
            ...
            <div className="text-center p-6 rounded-lg bg-gradient-card shadow-soft hover:shadow-lg hover:-translate-y-2 transition-all duration-300 animate-fade-in" style={{ animationDelay: "0.3s" }}>
              <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4 hover:scale-110 transition-transform">
            ...
            <div className="text-center p-6 rounded-lg bg-gradient-card shadow-soft hover:shadow-lg hover:-translate-y-2 transition-all duration-300 animate-fade-in" style={{ animationDelay: "0.4s" }}>
              <div className="w-16 h-16 bg-secondary/10 rounded-full flex items-center justify-center mx-auto mb-4 hover:scale-110 transition-transform">
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 items-center">
            <div className="flex items-center justify-center p-4 hover:scale-110 transition-transform duration-300 animate-fade-in" style={{ animationDelay: "0.1s" }}>
              <img src={unipampaLogo} alt="Unipampa" className="max-h-20 w-auto grayscale hover:grayscale-0 transition-all" />
            </div>
            <div className="flex items-center justify-center p-4 hover:scale-110 transition-transform duration-300 animate-fade-in" style={{ animationDelay: "0.2s" }}>
              <img src={pampatecLogo} alt="PampaTec" className="max-h-20 w-auto grayscale hover:grayscale-0 transition-all" />
            </div>
            <div className="flex items-center justify-center p-4 hover:scale-110 transition-transform duration-300 animate-fade-in" style={{ animationDelay: "0.3s" }}>
              <img src={ppgesLogo} alt="PPGES" className="max-h-20 w-auto grayscale hover:grayscale-0 transition-all" />
            </div>
            <div className="flex items-center justify-center p-4 hover:scale-110 transition-transform duration-300 animate-fade-in" style={{ animationDelay: "0.4s" }}>
              <img src={lamapLogo} alt="LAMAP" className="max-h-20 w-auto grayscale hover:grayscale-0 transition-all" />
            </div>
            <div className="flex items-center justify-center p-4 hover:scale-110 transition-transform duration-300 animate-fade-in" style={{ animationDelay: "0.5s" }}>
              <img src={leaLogo} alt="LEA" className="max-h-20 w-auto grayscale hover:grayscale-0 transition-all" />
            </div>
            <div className="flex items-center justify-center p-4 hover:scale-110 transition-transform duration-300 animate-fade-in" style={{ animationDelay: "0.6s" }}>
              <img src={alegreteLogo} alt="Prefeitura de Alegrete" className="max-h-20 w-auto grayscale hover:grayscale-0 transition-all" />
            </div>
          </div>
        </div>
      </section>
